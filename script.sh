...
#$ -o /srv/glusterfs/rheiki/logs/face_swap.txt
...
cd /srv/glusterfs/rheiki/faceswap/

# start training script
python faceswap.py train -A ./output/heiki -B ./output/coke -m ./models/
